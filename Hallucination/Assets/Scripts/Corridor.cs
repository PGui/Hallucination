...
public class Corridor : MonoBehaviour {
    ...
    Corridor InstantiateCorridor(Transform exitPosition)
    {
        ...
        int randomCorridorID = (int) Random.Range(0,4);
        tempCorridor = Instantiate(Resources.Load("Corridor#"+randomCorridorID.ToString())) as Corridor;
        ...
        tempCorridor.transform.localEulerAngles = new Vector3(tempCorridor.m_exitPositions[randomExitID].localEulerAngles.x + exitPosition.localEulerAngles.x, tempCorridor.m_exitPositions[randomExitID].localEulerAngles.y + exitPosition.localEulerAngles.y, tempCorridor.m_exitPositions[randomExitID].localEulerAngles.z + exitPosition.localEulerAngles.z);
